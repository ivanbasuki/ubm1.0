...
<form method="post" action="/ub/simpanNasabah">
...
<input type="hidden" name="xid_anggota" id="xid_anggota" value="<?= $id_anggota ?>">
<input type="hidden" name="xid_kredit" id="xid_kredit" value="<?= $id_kredit ?>">
...
<div class="form-group row">
    ...
    <div class="col-sm-6">
      <input type="date" class="form-control <?= (\Config\Services::validation()->hasError('tgl_transaksi') ? 'is-invalid' : '') ?>" id="tgl_transaksi" name="tgl_transaksi" value="<?= $tgl_transaksi; ?>" placeholder="Tanggal Transaksi">
