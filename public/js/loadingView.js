...
LoadingView = function(options) {
	...
	defaultOption.image = "/img/loader7.gif";			//You can change this anytime anyday based on your image location.
	defaultOption.imageClassName = "loadingImage";
	defaultOption.imageStyle = "position:absolute; top: 20%; left: 50%; transform: translate(-40%, -40%);";
